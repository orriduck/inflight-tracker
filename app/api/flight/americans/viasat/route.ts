...
/**
 * Maps ViaSat flight data to the universal FlightData format
 */
function mapViaSatToFlightData(data: AAViaSatFlightData): FlightData {
  return {
...
export async function GET() {
  try {
    ...
    const flightData = mapViaSatToFlightData(data);
