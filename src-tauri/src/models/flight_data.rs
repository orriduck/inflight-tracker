...
impl DataSource {
    /// Returns the priority level for this data source (higher number = higher priority)
...
impl FlightData {
    ...
    /// Check if this flight data has valid location information
    pub fn has_location_data(&self) -> bool {
        self.latitude != 0.0 && self.longitude != 0.0
    }

    /// Check if this flight data has a valid flight number
    pub fn has_valid_flight_number(&self) -> bool {
        !self.flight_number.is_empty() && self.flight_number != "N/A"
    }
}
