...
interface FlightChartGlassProps {
  flightData: FlightData[]
}

export default function FlightChartGlass({ flightData }: FlightChartGlassProps) {
  ...
  return (
    <GlassCard className="p-6 mb-4">
      <h2 className="text-xl font-semibold mb-4">Altitude & Ground Speed Over Time</h2>
