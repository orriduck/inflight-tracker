...
interface FlightMetricsGlassProps {
  data: FlightData;
  loading: boolean;
}

export default function FlightMetricsGlass({ data, loading }: FlightMetricsGlassProps) {
  ...
  return (
    <GlassCard className="p-6 mb-4">
      <h2 className="text-xl font-semibold mb-4">Flight Metrics</h2>
